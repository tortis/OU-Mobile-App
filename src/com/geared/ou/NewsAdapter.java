...
public class NewsAdapter extends BaseAdapter {
	...
	public NewsAdapter(Context context, ArrayList<SyndEntryImpl> news,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.titleLayout = (LinearLayout) convertView
					.findViewById(R.id.newsTitleLink);
			holder.titleTextView = (TextView) convertView
					.findViewById(R.id.newsTitleText);
			holder.dateTextView = (TextView) convertView
					.findViewById(R.id.newsDateText);
			holder.summaryTextView = (TextView) convertView
					.findViewById(R.id.newsSummaryText);
			holder.moreIcon = (ImageView) convertView
					.findViewById(R.id.newsMoreIcon);
		...
		holder.dateTextView.setText(news.get(position).getPublishedDate()
				.toLocaleString());
		holder.summaryTextView.setText(news.get(position).getDescription()
				.getValue());
